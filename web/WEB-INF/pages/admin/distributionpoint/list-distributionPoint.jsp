...
<body>
	...
	<h3>Listes des points de distributions</h3>
		...
		<tbody>
			...
			<c:forEach items="${distributionpoints}" var="distributionpoint">
				<tr>
					...
					<td>${distributionpoint.address.street}
						${distributionpoint.address.zip}
						${distributionpoint.address.tawn}</td>
					<td>${distributionpoint.productionManager}</td>

					<td><a href="edit.html?id=${distributionpoint.id}">Edit</a> <a
						href="delete.html?id=${distributionpoint.id}">Delete</a></td>
				</tr>
			</c:forEach>
		</tbody>
	</table>
